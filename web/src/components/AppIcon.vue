...
const apps: Record<string, string> = {
  ...
  // v9os 商店移植 webapps（批次 2）
  cad: tile('#7fd4ff', '#0f6cbd',
    `<rect x="4.8" y="4.8" width="14.4" height="14.4" rx="2"/><circle cx="12" cy="12" r="3.2" stroke-width="1.5"/><path d="M12 4.8V8.8M12 15.2v4M4.8 12h4M15.2 12h4" stroke-width="1.4"/>`),

  book: tile('#6ee88f', '#059669',
    `<path d="M7 6.8c1.8-1 3.4-1 5 0 1.6-1 3.2-1 5 0v10.4c-1.8-1-3.4-1-5 0-1.6-1-3.2-1-5 0V6.8z"/><path d="M12 6.8v10.4" stroke-width="1.8"/>`),
  code: tile('#5eead4', '#0d9488',
    `<path d="M9 8.6L5.8 12 9 15.4"/><path d="M15 8.6l3.2 3.4-3.2 3.4"/><path d="M12.8 7.4l-1.6 9.2" stroke-width="1.8"/>`),
  vector: tile('#fda4af', '#e11d48',
    `<path d="M6.8 17.2l1.6-4.8 5.4-5.4a1.6 1.6 0 0 1 2.3 2.3l-5.4 5.4-4.8 1.6z"/><path d="M12.8 9.2l2.4 2.4" stroke-width="1.6"/>`),
  mail: tile('#60a5fa', '#1d4ed8',
    `<rect x="5.6" y="7.4" width="12.8" height="9.6" rx="1.3"/><path d="M6.2 8.4L12 13l5.8-4.6" stroke-width="1.8"/>`),
  ps: tile('#12233d', '#0a1220',
    `<path d="M7.2 16.6V7.4h2.6a2.6 2.6 0 0 1 0 5.2H7.2M11.8 12.4h1.2a2.6 2.6 0 0 1 0 5.2h-2.6v-5.2z" stroke-width="2.4"/>`),
